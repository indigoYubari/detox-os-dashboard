...
import { agentValg, funnLede, nyesteForst, periodeValg, typeValg, type FilterValg } from "./funn"

// «Funnene» — porten av (main)/radar inn i den nye flaten. Alt agentene fant
...
//
// Stien heter /funn og ikke /radar fordi (main)/radar fortsatt finnes: Next
// nekter to sider paa samme sti, og den gamle flaten roeres ikke.
