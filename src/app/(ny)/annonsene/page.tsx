...
import { AnnonseneISeg } from "./AnnonseneISeg"
import { DAGER } from "./annonsene"
...
//
// Stien heter /annonsene og ikke /annonser fordi (main)/annonser fortsatt
// finnes: Next nekter to sider paa samme sti, og den gamle flaten roeres ikke.
