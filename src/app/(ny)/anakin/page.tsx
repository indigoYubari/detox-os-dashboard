...
// «Anakin» — porten av (main)/eiere inn i den nye flaten. Seks baand som
// foer: pulsen, planen, briefingen, samtalene, koeen og uken — alle lest med
...
//
// Stien heter /anakin og ikke /eiere fordi (main)/eiere fortsatt finnes:
// Next nekter to sider paa samme sti, og den gamle flaten roeres ikke. Naar
// (main) pensjoneres er dette et mappenavn.
