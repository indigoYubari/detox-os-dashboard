...
// Server Actions for /anakin (den nye flatens port av (main)/eiere). Eneste
...
// Logikken er den samme som i (main)/eiere/actions.ts — kopiert hit fordi den
// gamle flaten er avviklet og ikke skal importeres fra.
